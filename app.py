...
def login_page():
    ...
    with col2:
        st.markdown('<div class="login-panel{background-color: rgba(0, 0, 0, 0.70); padding: 2.5rem 2rem 2rem 2rem; border-radius: 20px; box-shadow: 0 4px 20px rgba(0,0,0,0.5); }">', unsafe_allow_html=True)
